...
## Step 1: Store (or not) Credential {.smaller}

![](media/store_credentials.png){.bordered}

## Step 2: Sign in With Correct Identity {.smaller}

![](media/choose_account.png){.bordered}

## Step 3: Give permissions {.smaller}

![](media/sign_in_tidyverse.png){.bordered .one-half}![](media/grant_access.png){.bordered .one-half}
...
:::
::: {.column width="67%"}
![](media/complete_auth_process.png){.bordered .one-half}
:::
:::
...
![](media/vertex_ai_workbench.png){.bordered .one-third}![](media/enable_notebooks_api.png){.bordered .one-third}
::: note
